    ...
    placeholder="Search manager">
       ...
       ?>
                ...
                <td> <?php echo  $result ['email_id'];?> </td>
				  ...
				  <td><?php echo $result ['solved_complaint'];?></td>
                 
					<td>
                    <a href="manageredit.php?id=<?php echo $result['manager_id'];?>" class="btn_1 gray edits">Edit</a>
                  </td>
                  
				  <td>

                   <a href="managerdelete.php?id=<?php echo $result['manager_id'];?>" onclick="return val()" class="btn_1 gray delete">Delete</a>
					</td>
                </tr>
      ...
      function val()
      {
        conf=confirm('Are you sure to delete this manager?');
        if(conf)
          return true
        else
          return false
