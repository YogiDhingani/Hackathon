...
<body class="fixed-nav sticky-footer" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-default fixed-top" style="background-color: #1e166f;" id="mainNav">
    <a class="navbar-brand" href="index.php"><img src="img\C.png" data-retina="true" alt="" width="50" height="50"></a>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" href="index.php">
            ...
            <span class="nav-link-text">Dashboard</span>          </a>        </li>
		 	<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Pending_Complaints">
          <a class="nav-link" href="viewpendingcomplaint.php">
            <i class="fa fa-fw fa-plus-circle"></i>
            <span class="nav-link-text">Pending Complaints</span>          </a>        </li>
           
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Solved_Complaints">
          <a class="nav-link" href="viewsolvedcomplaint.php">
            <i class="fa fa-fw fa-plus-circle"></i>
            <span class="nav-link-text">Solved Complaints</span>          </a>        </li>
        
             <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Total_Complaints">
          <a class="nav-link" href="viewcomplaint.php">
            <i class="fa fa-fw fa-plus-circle"></i>
            <span class="nav-link-text">Total Complaints</span>          </a>        </li>
        
	<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Profile">
          <a class="nav-link" href="manager.php">
            <i class="fa fa-fw fa-plus-circle"></i>
            <span class="nav-link-text">Profile</span>          </a>        </li> 
        ...
        <!--li class="nav-item" data-toggle="tooltip" data-placement="right" title="My profile">
          ...
          <a class="nav-link" href="master.php">
            ...
            <span class="nav-link-text">Add Manager</span>          </a>        </li>
			                      <li class="nav-item" data-toggle="tooltip" data-placement="right" >
          <a class="nav-link" href="viewmaster.php">
            <i class="fa fa-fw fa-plus-circle"></i>
      ...
      <li>
              <a href="viewmaster.php">Masters</a>            </li>
              <!--li>
